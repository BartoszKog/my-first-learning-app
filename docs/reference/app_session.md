...
slash-separated playlist; the current clip is not paused or stopped. Repeating
the same cached file skips remounting and the load wait so the speaker can
replay immediately. Not a general store for form fields or domain data — see
